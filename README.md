...
Set up tools required and local hadoop cluster for development.
...
Through an example with multiple pipe-lines some more advanced concepts will be presented.

* **Testing & BDD** 
Best practices of first defining behaviour - **Behaviour Driven Development**, 
and then tests - **Test Driven Development** before proceeding to implementation.
